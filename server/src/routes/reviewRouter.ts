...
import { createReview, deleteReview, getAllReviews, getReviewById, getReviewsByPropertyId, updateReview } from "../controllers/reviewController";
 ...
 *     responses:
 *       200:
 *         description: A list of reviews for the specified property
 */
reviewRouter.get("/property/:propertyId", getReviewsByPropertyId);
