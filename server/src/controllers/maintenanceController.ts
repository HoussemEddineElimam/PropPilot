...
const createMaintenanceRequest = async (req: Request, res: Response):Promise<void> => {
    ...
    const token = req.headers.authorization;
        ...
        if (!propertyId || !clientId || !description) {
        ...
        await updateUserMaintenanceRequests(savedMaintenanceRequest.clientId!,savedMaintenanceRequest._id!);
        await updatePropertyMaintenanceRequests(savedMaintenanceRequest.propertyId!,savedMaintenanceRequest._id!);
