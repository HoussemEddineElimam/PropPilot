...
const getReviewsByPropertyId = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const reviews: Review[] = await reviewRepository.find({ propertyId: new ObjectId(propertyId) });
...
export {getAllReviews,getReviewById,createReview,updateReview,deleteReview,getReviewsByPropertyId}